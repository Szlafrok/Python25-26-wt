...
Proszę napisać program, który zmienia wartości w liście - podnosi je do potęgi trzeciej. Mając listę `[0, 2, 5]` oczekujemy `[0, 8, 125]`. Nie twórz nowej listy na wyniki. Załóż, że dostajesz na wstępie listę zawierającą wyłącznie liczby naturalne.
